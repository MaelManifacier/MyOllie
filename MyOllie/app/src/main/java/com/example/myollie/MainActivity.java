...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, RobotChangedStateListener {
    ...
    private float VIVACITE_OLLIE = 0.5f;
    ...
    private Button vitesse1;
    private Button vitesse2;
    private Button vitesse3;
...
//                        ollie.sendCommand(new RGBLEDOutputCommand(0.5f, 0.5f, 0.5f));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vitesse1 = (Button) findViewById(R.id.vitesse1);
        vitesse2 = (Button) findViewById(R.id.vitesse2);
        vitesse3 = (Button) findViewById(R.id.vitesse3);

        vitesse1.setText("0.2");
        vitesse2.setText("0.6");
        vitesse3.setText("1");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.button2:
                ...
                if(ollie != null) ollie.sendCommand(new RGBLEDOutputCommand(0.1f, 0.7f, 0.8f));
                break;
            case R.id.button5:
                Log.d("Button", "Button5");
                if(ollie!=null) ollie.sendCommand( new RGBLEDOutputCommand( 0.5f, 1f, 0.2f ) );
//                ollie.drive(180.0f, VIVACITE_OLLIE);
                break;
            case R.id.button4:
                Log.d("Button", "Button4");
                if(ollie!=null) ollie.sendCommand(new RGBLEDOutputCommand(1f, 0.3f, 0.2f));
//                ollie.drive(270.0f, VIVACITE_OLLIE);
            ...
            case R.id.randomButton:
                ...
                float lol = RANDOM.nextFloat();
                float reda = lol;

                float lola = RANDOM.nextFloat();
                float greena = lola;

                float lolb = RANDOM.nextFloat();
                float bluea = lolb;

                Button leBouton = (Button) findViewById(R.id.randomButton);
                leBouton.setBackgroundColor(Color.rgb(red, green, blue));

                if(ollie!=null) ollie.sendCommand(new RGBLEDOutputCommand(reda, greena, bluea));
                break;
            case R.id.button3:
    ...
    public void changementVitesse(View v){
        switch (v.getId()){
            case R.id.vitesse1:
                this.VIVACITE_OLLIE = 0.2f;
                break;

            case R.id.vitesse2:
                this.VIVACITE_OLLIE = 0.6f;
                break;

            case R.id.vitesse3:
                this.VIVACITE_OLLIE = 1f;
                break;
        }
    }
    ...
    public void handleRobotChangedState(Robot robot, RobotChangedStateNotificationType robotChangedStateNotificationType) {
        switch (robotChangedStateNotificationType){
            case Online:
                ...
                textOllie.setText("Ollie connecté");
        }
    }
}
